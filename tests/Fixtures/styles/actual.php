...
use Acme\Bar;use Acme\Foo;use N\{AnotherClassName,ClassName,OneMoreClassName};
enum Suit: string
{case  Clubs  =   'C'   ;

case   Diamonds =   'D';case  Hearts  =   'H'
;
